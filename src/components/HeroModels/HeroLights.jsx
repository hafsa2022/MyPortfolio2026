...
const HeroLights = () => {
  // ✅ FIX: useMemo creates the object once and is safe to access during render
  const rectLight = useMemo(() => new THREE.RectAreaLight("#ffafcc", 6, 2.5, 1.5), []);
  ...
  return (
    <>
      ...
      {/* ✅ FIX: Use ref instead of `new THREE.RectAreaLight()` inline */}
      <primitive
        object={rectLight}
        position={[0, 2.2, 2.5]}
        rotation={[0, Math.PI, 0]}
